...
export const AGRUPADAS_SECOES = [
  ...
  },
  {
    nome: 'II. Descoberta espiritual', itens: [
      ...
      { codigo: '13', tag: '11-12-13-14-15+', tipo: 'Leitura', texto: 'Leitura bíblica — Gênesis: 1-9, 11-24, 27-33, 37, 40-45, 47, 50. Êxodo: 1-5, 7-10, 12-20, 24, 32, 33, 34, 35, 40.' },
      { codigo: '14', tag: '11-12-13-14-15+', tipo: 'Leitura', texto: 'Leitura bíblica — Levítico 11; Números 9-14, 16, 17, 20-24; Deuteronômio 1, 32-34; Josué 1-7, 9, 24; Juízes 6, 7, 13-16; Rute 1-4; 1 Samuel 1-6, 8-13, 15-18, 20-22, 24-26, 31; 2 Samuel 1, 5-7, 9, 11, 12, 15, 18.' },
      { codigo: '15', tag: '12-13-14-15+', tipo: 'Leitura', texto: 'Leitura bíblica — 1 Reis 1, 3-6, 8, 10-12, 16-19, 21; 2 Reis 2, 4-7, 20, 22-25; 2 Crônicas 24, 36; Esdras 1, 3, 6; Neemias 1, 2, 4, 8; Ester 1-8; Jó 1, 2, 42; Salmos diversos; Provérbios 1, 3, 4, 10, 15, 20, 25; Eclesiastes 1.' },
      { codigo: '16', tag: '13-14-15+', tipo: 'Leitura', texto: 'Leitura bíblica — Eclesiastes 3, 5, 7, 11, 12; Isaías 5, 11, 26, 35, 40, 43, 52, 53, 58, 60, 61; Jeremias diversos; Daniel 1-12; Joel 2; Amós 7, 8; Jonas 1-4; Miqueias 4; Ageu 2; Zacarias 4; Malaquias 3, 4; Mateus 1-23.' },
      { codigo: '17', tag: '14-15+', tipo: 'Leitura', texto: 'Leitura bíblica — Mateus 24-28; Marcos 7, 9-12, 16; Lucas 1, 2, 7, 8, 10-24; João 1-6, 8-15, 17-21; Atos 1-8.' },
      { codigo: '18', tag: '15+', tipo: 'Leitura', texto: 'Leitura bíblica — Atos 9-28; Romanos 12-14; 1 Coríntios 13; 2 Coríntios 5, 11, 12; Gálatas 5, 6; Efésios 5, 6; Filipenses 4; Colossenses 3; 1 Tessalonicenses 4, 5; 2 Tessalonicenses 2, 3; 1 Timóteo 4-6; 2 Timóteo 2, 3; Filemom; Hebreus 11; Tiago 1, 3, 5; 1 Pedro 1, 5; 2 Pedro 3; 1 João 2-5; Judas 17-25; Apocalipse 1-3, 7, 12-14, 19-21.' },
      ...
      { codigo: '22', tag: '11-12-13-14-15+', texto: 'Em consulta com seu Conselheiro, escolher um dos seguintes temas e demonstrar seu conhecimento sobre ele:', grupoEscolha: { necessarias: 1 }, subitens: [
        ...
        { sub: 'e', texto: 'Demonstrar via: troca de ideia com o Conselheiro, atividade em grupo ou redação.' },
      ] },
      { codigo: '23', tag: '12-13-14-15+', texto: 'Conversar com seu líder e escolher uma das seguintes histórias, demonstrando sua compreensão de como Jesus salva as pessoas:', grupoEscolha: { necessarias: 1 }, subitens: [
